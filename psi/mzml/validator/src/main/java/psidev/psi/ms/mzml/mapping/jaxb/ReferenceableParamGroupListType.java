...
public class ReferenceableParamGroupListType {
    ...
    private String elementName = "referenceableParamGroupList";

    public ReferenceableParamGroupListType() {}

    public ReferenceableParamGroupListType(String xmlSnippet) {
        parseXml(xmlSnippet);
    }

    public ReferenceableParamGroupListType(Element element) {
        create(element);
    }
    ...
    private void create(Node node) {
        ...
        if (ele != null) {
            ...
            // load elements
            NodeList nl = ele.getElementsByTagName("referenceableParamGroup");
            for ( int i = 0; i < nl.getLength(); i++ ) {
                this.getReferenceableParamGroup().add(new ReferenceableParamGroupType((Element) nl.item(i)));
            }
