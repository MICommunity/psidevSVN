...
public class SpectrumListType {
    ...
    private String elementName = "spectrumList";

    public SpectrumListType() {}

    public SpectrumListType(String xmlSnippet) {
        parseXml(xmlSnippet);
    }

    public SpectrumListType(Element element) {
        create(element);
    }
    ...
    private void create(Node node) {
        ...
        if (ele != null) {
            ...
            // load elements
            NodeList nl = ele.getElementsByTagName("spectrum");
            for ( int i = 0; i < nl.getLength(); i++ ) {
                this.getSpectrum().add(new SpectrumType((Element) nl.item(i)));
            }
